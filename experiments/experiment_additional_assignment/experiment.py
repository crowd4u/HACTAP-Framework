...
parser.add_argument(
    '--solver',
    default='cta_mv',
    choices=['cta_mv', 'gta_mv', 'cta_interactive', 'gta_interactive']
)
...
def main():
    ...
    elif args.solver == 'cta_interactive':
        solver = solvers.CTA_Interactive(
            tasks,
            human_crowd,
            ai_workers,
            args.quality_requirements,
    ...
    elif args.solver == 'gta_interactive':
        solver = solvers.GTA_Interactive(
            tasks,
            human_crowd,
            ai_workers,
            args.quality_requirements,
