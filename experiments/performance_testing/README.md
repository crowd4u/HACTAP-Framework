...
```
python gta.py --task_size 10000 --human_crowd_batch_size 2000 --quality_requirements 0.9 --solver gta_retire --prior_distribution 1, 9
```
...
batch
```
parallel --dry-run --joblog ./jobs.log --result ./parallel_out_gta -j 1 'python gta.py --group_id test_gta --trial_id {1} --task_size 10000 --solver gta --human_crowd_batch_size {2} --quality_requirements {3} --minimum_sample_size {4}' ::: {1..10} ::: 200 500 ::: 0.8 0.85 0.9 0.95 ::: -1 0 50 100
```
...
batch
```
parallel --dry-run --joblog ./jobs.log --result ./parallel_out_ala -j 1 'python ala.py --group_id test_ala --trial_id {1} --task_size 10000 --human_crowd_batch_size 500 --quality_requirements {2} --solver {3} --test_with_random {4}' ::: {1..10} ::: 0.8 0.85 0.9 0.95 ::: ala_us ala_qbc ::: True False
```
