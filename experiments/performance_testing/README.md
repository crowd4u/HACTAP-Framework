...
batch
```
parallel --dry-run --joblog ./jobs.log --result ./parallel_out_gta2 -j 1 'python gta.py --group_id test_gta --trial_id {1} --task_size 10000 --human_crowd_batch_size 200 --quality_requirements {2} --solver {3} --n_monte_carlo_trial {4}' ::: {1..10} ::: 0.8 0.85 0.9 0.95 ::: gta gta_retire gta_onetime ::: 100000
```
