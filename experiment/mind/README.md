...
```
parallel --joblog ./jobs.log --result ./parallel_out -j 1 'python experiment.py --group_id demo --trial_id {1} --human_crowd_batch_size 1000 --quality_requirements {2} --solver {3}' ::: {1..3} ::: 0.85 0.9 0.95 ::: gta
```
